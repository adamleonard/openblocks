...
public class BlockLabel implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public final static Font blockFontSmall_Bold = new Font("Dialog", Font.BOLD, 7);
    public final static Font blockFontMedium_Bold = new Font("Dialog", Font.BOLD, 10);
    public final static Font blockFontLarge_Bold = new Font("Dialog", Font.BOLD, 12);
